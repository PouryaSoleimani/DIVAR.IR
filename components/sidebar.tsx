...
export const Sidebar = () => {
  return (
    <div id="sideBarCategories" className='tracking-tighter h-full w-fit text-[14px] border-b border-zinc-300 flex items-start justify-start pr-4 text-zinc-500 leading-5 pl-10 '>
