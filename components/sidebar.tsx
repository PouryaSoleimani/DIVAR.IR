...
export const Sidebar = () => {
  ...
  return (
    <section className='flex flex-col items-start justify-start'>
      <div id="sideBarCategories" className='tracking-tighter h-fit pb-6 w-fit text-[8px] sm:text-[14px] border-b border-zinc-300 flex items-start justify-start pr-2 overflow-hidden text-zinc-500 leading-5 pl-16 '>
